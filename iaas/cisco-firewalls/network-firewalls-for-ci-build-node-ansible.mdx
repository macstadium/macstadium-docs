...
zendesk_url: "/iaas/cisco-firewalls/network-firewalls-for-ci-build-node-ansible"
section: "Cisco Firewalls"
category: "IaaS"
created_at: "2024-08-12T15:50:00Z"
updated_at: "2025-11-18T14:27:46Z"
promoted: false
labels: ["firewall", "ci/cd", "cloud", "infrastructure", "ansible", "ci", "network"]
suggested_new_path: "/iaas/cisco-firewalls/network-firewalls-for-ci-build-node-ansible"
---
...
The [OSX-CI](https://github.com/macstadium/ansible-role-osx-ci) requires a path to a public public ssh key on the target machine. The role adds the key to the `authorized_keys` file of the created user to enable remote login via ssh with a private key.
