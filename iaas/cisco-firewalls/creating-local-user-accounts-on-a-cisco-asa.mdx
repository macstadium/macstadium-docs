...
zendesk_url: "/iaas/cisco-firewalls/creating-local-user-accounts-on-a-cisco-asa"
section: "Cisco Firewalls"
category: "IaaS"
created_at: "2024-08-14T16:28:47Z"
updated_at: "2025-11-18T14:27:46Z"
promoted: false
labels: ["firewall", "cisco", "account", "asa", "local", "user"]
suggested_new_path: "/iaas/cisco-firewalls/creating-local-user-accounts-on-a-cisco-asa"
---
...
To begin the steps on how to create additional local user accounts, obtain the existing account information from the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883).
...
Using a CLI allows the user to write script changes in a notepad, and have those changes reviewed by someone before running those scripts. This method is good for users writing scripts.

**Via Cisco Adaptive Security Device Manager (ASDM)**

Using a ASDM allows the user to make line by line changes, while using a graphical user interface (GUI).
...
![4c42e77-image.png](https://support.macstadium.com/hc/article_attachments/28269076765723)
  3. Click Device Management.  
![c121439-image.png](https://support.macstadium.com/hc/article_attachments/28269093217051)
  4. Click Users/AAA.  
![a2714fa-image.png](https://support.macstadium.com/hc/article_attachments/28269093218075)
...
![8dded1a-image.png](https://support.macstadium.com/hc/article_attachments/28269093219099)
...
\<https://www.cisco.com/c/en/us/td/docs/security/asa/asa918/asdm718/general/asdm-718-general-config/aaa-local.html>

\<https://www.cisco.com/c/en/us/td/docs/security/asa/asa914/configuration/general/asa-914-general-config/aaa-local.html>
