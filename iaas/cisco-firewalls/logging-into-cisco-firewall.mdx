...
Use the Cisco ASDM-IDM Launcher to reach and configure the firewall.
  ...
  2. Enter the following data and click OK: 
     ...
     * For Username and Password, provide the VPN credentials used with Cisco AnyConnect. They are Step 1: VPN section on the One Page sheet of the [IP Plan](/macstadium/macstadium-overview/ip-plan). 
