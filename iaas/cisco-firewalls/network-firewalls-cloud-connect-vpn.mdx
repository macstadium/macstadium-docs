...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28244765690395-Network-Firewalls-Cloud-Connect-VPN"
section: "Cisco Firewalls"
category: "IaaS"
created_at: "2024-08-13T19:40:57Z"
updated_at: "2025-11-18T14:27:46Z"
promoted: false
labels: ["firewall", "cloud", "network", "connect", "vpn"]
suggested_new_path: "/iaas/cisco-firewalls/network-firewalls-cloud-connect-vpn"
---
...
**Download and Install OpenConnect**
  ...
  * Windows users, can [download](https://www.infradead.org/openconnect/download.html) and [build](https://www.infradead.org/openconnect/building.html) the OpenConnect package or use [Cisco AnyConnect](https://support.macstadium.com/hc/en-us/articles/28244765690395) instead.
...
The DNS server address is the `.251` address for the `Private-1` network from the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883). For example: `10.10.10.251` or `10.221.188.251`.
...
![b92a4bd-openconnect-1.png](https://support.macstadium.com/hc/article_attachments/28246921126683)
...
### Download and install Cisco AnyConnect
  ...
  1. In the browser, navigate to the server address from Step 1: VPN of the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883). Use https://.
...
![1bfd9a3-openconnect-2.png](https://support.macstadium.com/hc/article_attachments/28246921130011)
  4. When prompted, download, install, and run the Cisco AnyConnect desktop client.  
![00c4bd0-openconnect-3.png](https://support.macstadium.com/hc/article_attachments/28246906125851)
...
![ciscologin.png](https://support.macstadium.com/hc/article_attachments/41209805088667)  
 ...
 * Click Connect again.  
```
![blockconnections.png](https://support.macstadium.com/hc/article_attachments/41209843041947)  
