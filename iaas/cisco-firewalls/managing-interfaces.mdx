...
description: "Manage interfaces via the Cisco Adaptive Security Device Manager (ASDM), which = is done via Configuration > Device Setup > Interfaces."
zendesk_id: 28277745764123
zendesk_url: "/iaas/cisco-firewalls/managing-interfaces"
section: "Cisco Firewalls"
category: "IaaS"
created_at: "2024-08-14T20:06:16Z"
updated_at: "2025-11-18T14:27:46Z"
promoted: false
labels: ["firewall", "configuration", "manage", "config"]
suggested_new_path: "/iaas/cisco-firewalls/managing-interfaces"
---
...
To turn _logging _on, you will first need to identity a repository for the log information. MacStadium recommends designating a separate repository for those log files, because it can grow quickly. This can be set in ASDM via **Monitoring > Logging**. Users can also submit a firewall change request via the MacStadium portal to choose a new repository.

Users running CI as a service, should port those logs to a separate server. Otherwise, speed, storage, and performance may become impacted. MacStadium also recommends that leaving logging disabled, especially for internal-only customers.
