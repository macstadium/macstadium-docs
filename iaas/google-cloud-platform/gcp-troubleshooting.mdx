...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28313080123547-GCP-Troubleshooting"
section: "Google Cloud Platform"
category: "IaaS"
created_at: "2024-08-15T20:44:45Z"
updated_at: "2024-10-08T13:24:13Z"
promoted: false
labels: ["troubleshooting", "gcp", "google cloud platform"]
suggested_new_path: "/iaas/google-cloud-platform/gcp-troubleshooting"
---
...
Sometimes, the command line interface might return `ERROR: unable to find interface “outside”`. The command-line interface might be case-sensitive and you might need to preserve the capitalization of the MacStadium network configuration as provided in the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883).
  ...
  2. Rename outside in your configuration to the precise name of the outside interface of your Cisco ASA/ASAv device. By default, this is the Outside network. 
     * For more information, see [GCP VPN Config for Cisco ASA/ASAv](https://support.macstadium.com/hc/en-us/articles/28301505752219).
...
For more information about how to connect to the VPN, see [Connecting to Your Cloud (via VPN](https://support.macstadium.com/hc/en-us/articles/28230568733979)).
  ...
  3. For more information about how to log in to your firewall, see [Logging into Your Cisco Firewall](https://support.macstadium.com/hc/en-us/articles/28231599395355).  
In the Cisco ASDM-IDM application toolbar, select **Tools > Command Line Interface**.  
![3e9a00a-cisco-asdm-tools-menu.png](https://support.macstadium.com/hc/article_attachments/28313096629019)
...
|    
The public IP address of the cloud VPN gateway in GCP.   
| 
...
|    
The name of the private network in MacStadium that needs to be accessed by GCP. You can find the information about your private network in Appendix A of the IP Plan.   
| 
...
|    
You can find the information about your outside interface in Appendix A of the IP Plan.  | 
