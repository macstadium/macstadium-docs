...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28298738716699-Verify-GCP"
section: "Google Cloud Platform"
category: "IaaS"
created_at: "2024-08-15T14:34:14Z"
updated_at: "2024-09-18T21:48:41Z"
promoted: false
labels: ["verify", "gcp", "google cloud platform", "google cloud"]
suggested_new_path: "/iaas/google-cloud-platform/verify-gcp"
---
...
After you have completed both the Google Cloud Platform (GCP) and the MacStadium sides of the configuration, you might want to verify that the tunnel is working as expected.
  ...
  2. Run Cisco ASDM-IDM and log in. 
     * For more information about how to log in to your firewall, see [Logging into Cisco Firewall](https://support.macstadium.com/hc/en-us/articles/28231599395355).
  3. In the Cisco ASDM-IDM application toolbar, select **Tools > Command Line Interface  
**![97da5cd-cisco-asdm-tools-menu.png](https://support.macstadium.com/hc/article_attachments/28298743710747)
...
## Verify that there is an IPsec security association between peers
  ...
  2. Run Cisco ASDM-IDM and log in. 
     * For more information about how to log in to your firewall, see [Logging into Cisco Firewall](https://support.macstadium.com/hc/en-us/articles/28231599395355).
  3. In the Cisco ASDM-IDM application toolbar, select Tools > Command Line Interface  
![9bf2163-cisco-asdm-tools-menu.png](https://support.macstadium.com/hc/article_attachments/28298743712283)
  4. Select Single Line, enter the following command, and click Send.
...
![d336b02-select-vpn.png](https://support.macstadium.com/hc/article_attachments/28298738704027)
...
![c717acd-vpn-tunnel-status.png](https://support.macstadium.com/hc/article_attachments/28298743716635)
...
See our [GCP Troubleshooting](https://support.macstadium.com/hc/en-us/articles/28313080123547) doc for some common issues with GCP-MacStadium Site-to-Site VPN Connections.