...
Scroll right and click on CONFIGURE BGP SESSION at the first VPN tunnel.
  ...
  7. For Vendor select Cisco. For Platform, at the time of writing, Firepower is the only option available. On Software, confirm that >= ASA 9.13(1)2 is selected and click on DOWNLOAD.
  8. Next click OK.
