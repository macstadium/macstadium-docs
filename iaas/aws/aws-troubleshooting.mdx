...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28312073382299-AWS-Troubleshooting"
section: "AWS"
category: "IaaS"
...
The command-line interface returns `ERROR: unable to find interface "outside"`.
  ...
  * **Workaround** : Sometimes, the command line interface is case-sensitive and you need to preserve the capitalization of the MacStadium network configuration as provided in the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883).
  ...
  2. Rename outside in your configuration file to the precise name of the outside interface of your Cisco ASA/ASAv device. By default, this is the Outside network. 
     * For more information, see [AWS VPN Config for Cisco ASA/ASAv](https://support.macstadium.com/hc/en-us/articles/28280625682587).
  3. Re-run the complete configuration in Cisco ASDM-IDM. 
     * For more information, see [Site-to-Site VPN Config](https://support.macstadium.com/hc/en-us/articles/28297916166683).
...
All checks in this section are performed against the site-to-site VPN configuration file downloaded from Amazon. For more information, see [AWS VPN Config for Cisco ASA/ASAv.](https://support.macstadium.com/hc/en-us/articles/28280625682587)
...
Sometimes, you might need to clean up the Cisco ASA/ASAv configuration and start over.
  ...
  2. Run Cisco ASDM-IDM and log in. 
     * For more information about how to log in to your firewall, see [Logging in to Your Cisco Firewall](https://support.macstadium.com/hc/en-us/articles/28231599395355).
