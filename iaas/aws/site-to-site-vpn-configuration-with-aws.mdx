...
`<sla_monitor_address>` | An IP address in the Amazon VPC that can serve as an SLA monitor keeping the Site-To-Site tunnel alive. | Set this to an available host in the AWS VPC. The host must reply to ICMP echo requests. | 172.31.0.5
