...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28280561588507-Site-To-Site-VPN-Configuration-with-AWS"
section: "AWS"
category: "IaaS"
...
**NOTES** :
  ...
  * For more information, see [Connecting to Your Cloud (via VPN)](https://support.macstadium.com/hc/en-us/articles/28230568733979)
...
## Creating Stable IPSec Site-to-Site VPN
  ...
  2. Configure the private cloud to connect to your MacStadium cloud. One or more of the following must be configured: 
     * Provide the public endpoint of the MacStadium cloud. 
       * This is the public network IP listed for the FW1-Outside network in Appendix B of the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883).
...
**NOTE** : A one-time or temporary access must be established from a single virtual or physical machine to the MacStadium cloud. It is recommended to use Cisco AnyConnect VPN. For more information, see [Connect to Your Cloud via VPN](https://support.macstadium.com/hc/en-us/articles/28230568733979).
...
## Creating IPSec Site-To-Site VPN between Two Clouds
  ...
  2. Configure the private cloud to connect to the MacStadium cloud. 
     * One or more of the following might need to be configured. 
       * Provide the public endpoint of the MacStadium cloud. 
         * Usually, this is the public network IP listed for the FW1-Outside network in Appendix B of the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883).
...
![cc3b204-image.png](https://support.macstadium.com/hc/article_attachments/28280561568795)
...
![3a7c313-image.png](https://support.macstadium.com/hc/article_attachments/28280561569691)
...
**NOTE** : For more information about the virtual private gateway, see [Amazon VPC Documentation: Components of Your Site-To-Site VPN](https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html#VPN).
  ...
  5. Connect to the VPN. 
     * After signing up, the [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883) is sent. Review that information to configure access to the cloud environment. The recommended method of gaining access is via a Virtual Private Network (VPN), which is both easy to implement and secure.  
![65f35b0-image.png](https://support.macstadium.com/hc/article_attachments/28280561571355)
...
![c7e601a-image.png](https://support.macstadium.com/hc/article_attachments/28280561573019)
  7. Select the VPC to attach the Virtual Private Gateway to and click Attach to VPC.  
![3df10bf-image.png](https://support.macstadium.com/hc/article_attachments/28280561574811)
  8. Select the Propagation Enable checkbox.
  9. Click Save.  
![ebd2e0c-image.png](https://support.macstadium.com/hc/article_attachments/28280513704859)
...
![089ae6a-image.png](https://support.macstadium.com/hc/article_attachments/28280561577499)
...
**NOTE** : Proceed with the [AWS VPN configuration for Cisco.](https://support.macstadium.com/hc/en-us/articles/28280625682587)
...
Amazon has prefilled configurations ready for download, from a variety of vendors. The default firewall vendor for MacStadium private clouds is Cisco Systems, Inc.
  ...
  1. Verify there is a Site-To-Site VPN connection in Amazon. 
     * For more information about how to set up your VPN, see [Setting Up the AWS Side of the Site-To-Site VPN](https://support.macstadium.com/hc/en-us/articles/28294500691739).
...
![4664a5f-image.png](https://support.macstadium.com/hc/article_attachments/28294681888539)
...
By default, this is the Private-1 network. | [The IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883) | 10.221.254.0  
...
Plan.  
By default, the value is Outside. | [The IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883) | Outside  
...
Appendix A of your IP Plan. By default, this is the Private-1 network. | [The IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883) | 10.221.254.0  
      
    
    <local_subnet_mask>

|  The subnet mask for the internal private LAN of the MacStadium cloud as provided in Appendix A of the IP Plan. By default, this is the Private-1 network. | [The IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883) | 255.255.255.0  
...
To complete configuration into the Cisco ASA/ASAv, see Setting Up the [MacStadium Side of the Site-To-Site VPN](https://support.macstadium.com/hc/en-us/articles/28297916166683).
...
![3f83127-image.png](https://support.macstadium.com/hc/article_attachments/28297099978011)
...
![8b4497b-image.png](https://support.macstadium.com/hc/article_attachments/28297115653403)
...
For Windows users, download ([build](https://www.infradead.org/openconnect/download.html)) the [OpenConnect package or use Cisco AnyConnect](https://support.macstadium.com/hc/en-us/articles/28230568733979).
...
Cisco firewalls are designed to work with the [Cisco AnyConnect Secure Mobility Client ](https://www.cisco.com/c/en/us/support/security/anyconnect-secure-mobility-client/series.html)as a VPN client. Users who prefer a GUI VPN client or prefer running on Windows, use Cisco AnyConnect.
  ...
  * [Download and use Cisco AnyConnect](https://support.macstadium.com/hc/en-us/articles/28230568733979)
