...
![Private Cloud Cloud Snapshots left menu with New option](/images/attachments/43967899173019.png)
  ...
  * In the **Expires** field, select a date and time for expiration.




In the **Expiration Type** field, **Never Expire** can be selected, however, this can cause the snapshot to consume substantial amounts of storage. It is not recommended to use the Never Expire option unless absolutely necessary.

![Private Cloud New Cloud Snapshot form with Name, Description, and Expires fields](/images/attachments/43967899176219.png)

  5. The **Private** checkbox is selected by default. This option pertains to multitenancy, and can be ignored in the majority of cases.
