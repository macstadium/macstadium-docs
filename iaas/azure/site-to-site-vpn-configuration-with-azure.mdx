...
![1405fda-image.png](/images/attachments/28300178271259.png)
  ...
  8. Select your SKU 
     * <Note>For more information about the available SKUs, see Azure Documentation: [Gateway SKUs](https://learn.microsoft.com/en-gb/azure/vpn-gateway/vpn-gateway-about-vpngateways).</Note>
...
![d15ca57-image.png](/images/attachments/28300162004635.png)
  ...
  7. Enter the private ASN number to use, for instance 65516. 
     * <Note>Notice that ASNs 8075, 8076, 12076 (public), 65515, 65517, 65518, 65519, 65520 (private) are reserved by Azure and cannot be used.</Note>
...
![9cd73fc-image.png](/images/attachments/28300178285851.png)
  ...
  8. For Shared key (PSK), provide an IPSec pre-shared key. 
     * <Note>Keep a record of the pre-shared key. It will be used later.</Note>
...
![5086e73-image.png](/images/attachments/28300162047643.png)
  ...
  * <Note>The status of the newly created connection is Unknown.</Note>
...
```
     * <Note>Find the MacStadium Private Network by checking that section in Appendix A of the IP Plan.</Note>
     * <Note>Make sure the name of the interface being used for the VPN connection is Outside as this is the name of the interface in the script downloaded from Azure. If there is a different interface name for the VPN, then make sure to replace all sections where the Outside interface is referenced in the script by the actual interface name being used.</Note>
     * <Warning>Ignore the section, STATIC ROUTING SETUP FOR AZURE, and do not configure any static routes, as BGP will be used instead.</Warning>
...
```
     * <Note>For more information, see: [Cisco Secure Firewall ASA Series Command Reference, S Commands](https://www.cisco.com/c/en/us/td/docs/security/asa/asa-cli-reference/S/asa-command-ref-S/show-cr-to-show-cz-commands.html).</Note>
  7. Save the configuration with the ASA CLI command: write memory.
     ...
     * <Note>To feed the complete configuration into your Cisco ASA/ASAv, see [Site-to-Site VPN Config](/iaas/connecting-to-other-clouds/site-to-site-vpn-config).</Note>