...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28300178337051-Site-to-Site-VPN-Configuration-with-Azure"
section: "Azure"
category: "IaaS"
...
**NOTE** : To proceed with the MacStadium side of the configuration, see Azure [VPN Config for Cisco ASA/ASAv](https://support.macstadium.com/hc/en-us/articles/28299207547547).
...
![b7754df-image.png](https://support.macstadium.com/hc/article_attachments/28300178321819)
  ...
  7. Save the configuration with the ASA CLI command: write memory.  
     ...
     * **NOTE** : To feed the complete configuration into your Cisco ASA/ASAv, see [Site-to-Site VPN Config](https://support.macstadium.com/hc/en-us/articles/28297916166683).