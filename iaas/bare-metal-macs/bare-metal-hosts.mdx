...
|------|------|-----------|-----|-----|----------|
| M2.S | M2 | 8 | 8 GB | 256 GB | Light CI/CD, basic automation |
| M2.M | M2 | 8 | 16 GB | 1 TB | CI/CD, Orka nodes |
| M2.L | M2 Pro | 10 | 16 GB | 1 TB | CI/CD, Orka nodes |
| M2.XL | M2 Pro | 12 | 32 GB | 2 TB | CI/CD pipelines, Orka clusters |
| M4.S | M4 | 10 | 16 GB | 256 GB | Light CI/CD, basic automation |
| M4.M | M4 | 10 | 24 GB | 512 GB | CI/CD, Orka clusters |
...
**For Orka clusters:** Medium and larger configurations (M2.M and above) are recommended. More RAM means more concurrent VMs per node — M4.M and above are the best fit for teams running multiple VMs simultaneously.

## Mac Studio

Mac Studio is recommended for GPU-intensive workloads: video rendering, AI/ML inference, and compute-heavy pipelines that benefit from high GPU core counts and large memory bandwidth. Standard configurations are available for immediate purchase on the [MacStadium customer portal](https://portal.macstadium.com/register).

| Plan | Chip | CPU cores | RAM | SSD | Best for |
|------|------|-----------|-----|-----|----------|
| S1.M | M1 Max | 10 | 64 GB | 2 TB | GPU workloads, AI/ML inference, video rendering |
| S2.M | M2 Ultra | 24 | 64 GB | 2 TB | High-throughput GPU, large AI/ML models |
| S2.L | M2 Ultra | 24 | 128 GB | 2 TB | Very large AI/ML models, maximum memory GPU workloads |
