...
**5\. IP ALLOCATIONS.** All IP addresses which are assigned to Customer must be justified per ARIN Guidelines at [https://www.arin.net/policy/nrpm.html](https://www.arin.net/policy/nrpm.html). If it is determined that IP addresses which have been assigned to Customer are not being used in accordance with these guidelines, they may be revoked.
