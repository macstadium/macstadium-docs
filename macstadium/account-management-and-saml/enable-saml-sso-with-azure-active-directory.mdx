...
👍 Log into the Portal by going to [https://portal.macstadium.com/login](https://portal.macstadium.com/login).
...
[https://portal.macstadium.com/sso](https://portal.macstadium.com/sso)

## Overview

SAML SSO with Azure AD allows you to:

  * Enable automatic sign-in to MacStadium using your Azure AD accounts.
