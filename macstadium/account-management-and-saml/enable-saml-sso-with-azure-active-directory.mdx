---
title: "Enable SAML SSO with Microsoft Entra ID"
description: "Admin: set up SAML SSO for MacStadium Portal via Microsoft Entra ID (formerly Azure AD). Create an enterprise app, configure SAML settings, and share metadata with the MacStadium team."
