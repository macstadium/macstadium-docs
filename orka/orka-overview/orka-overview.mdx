...
This document will focus on using k8s as the control plane for Orka. For details on managing an Orka environment with the Ansible-based control plane, see [MacStadium VDI](/remote-desktop-vdi/orka-for-vdi-deployment/deployment-guide).
