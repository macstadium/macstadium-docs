...
Bare Metal Mac Nodes:
  ...
  * Apple silicon Support: Apple M1+ with 16GB RAM and 512GB disk space. (MacStadium recommends 1TB disk space); macOS 13.0+ (Ventura)
  * Apple Intel Support: Mac Intel with 16GB RAM and 1TB disk space; macOS 13.0 (Ventura)+
