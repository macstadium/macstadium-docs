...
description: "Save a new image from a running VM. This saves the file system and the state of the OS, including any running applications. You can preserve the original."
zendesk_id: 42514937795739
zendesk_url: "/orka/orka3-cli-reference/vm-lifecycle-management"
