...
description: "VM configurations (templates) allow you to define reusable settings for deploying virtual machines. All VM configurations reside in the orka-default."
zendesk_id: 42514591292955
zendesk_url: "/orka/orka3-cli-reference/vm-deployment-and-configuration"
