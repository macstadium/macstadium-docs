...
If your cluster has public NAT IPs or a custom domain configured for the Orka API, use your public URL instead of the internal IP address. Using the internal IP on a cluster with public API access will result in connection timeouts.
