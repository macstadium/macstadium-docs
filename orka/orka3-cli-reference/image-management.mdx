...
orka3 imagecache remove sonoma-90gb-orka3-arm --nodes mini-arm-10

# Remove from multiple nodes
orka3 imagecache remove sonoma-90gb-orka3-arm --nodes mini-arm-10,mini-arm-11

# Remove from all nodes in the current namespace
orka3 imagecache remove sonoma-90gb-orka3-arm --all

# Remove from nodes with specific tags
orka3 imagecache remove sonoma-90gb-orka3-arm --tags my-tag,my-other-tag

# Remove from a node in a specific namespace
orka3 imagecache remove sonoma-90gb-orka3-arm --nodes mini-arm-10 --namespace my-namespace
```
