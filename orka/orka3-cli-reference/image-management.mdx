...
| `Failed` | Remove job failed; image stays cached and will not retry automatically |
...
If removal reaches `Failed`, contact [support@macstadium.com](mailto:support@macstadium.com).
