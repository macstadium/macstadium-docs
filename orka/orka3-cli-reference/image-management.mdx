...
zendesk_url: "/orka/orka3-cli-reference/image-management"
section: "Orka3 CLI Reference"
category: "Orka"
created_at: "2025-10-23T21:53:55Z"
updated_at: "2026-01-16T14:21:29Z"
promoted: false
labels: []
suggested_new_path: "/orka/orka3-cli-reference/image-management"
---
...
**🚧 CAUTION:** This operation cannot be undone. VMs or VM configurations that use this image are affected and might stop working as expected.
...
**🚧 DEPRECATED:** This functionality will be removed in future releases. MacStadium recommends using OCI registries for image storage and management. The `orka3 imagecache` command should be used as a replacement to load images into the cluster.
