...
zendesk_url: "/orka/quick-start-guides/cicd-integrations-quick-start"
...
If you want to skip the detailed explanations, just run through these steps on your own:
  ...
  1. Review the list of available integrations at [Orka Tools & Integrations](/orka/orka-overview/tools-integrations) and choose the one you want to use.
