...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28394315916827-CI-CD-Integrations-Quick-Start"
section: "Quick Start Guides"
category: "Orka"
created_at: "2024-08-19T13:40:41Z"
updated_at: "2025-07-22T22:52:45Z"
promoted: false
labels: ["ci/cd", "delivery", "integration", "orka", "api", "integrations", "continuous"]
suggested_new_path: "/orka/quick-start-guides/cicd-integrations-quick-start"
---
...
If you want to skip the detailed explanations, just run through these steps on your own:
  ...
  1. Review the list of available integrations at [Orka Tools & Integrations](https://support.macstadium.com/hc/en-us/articles/28347376278299) and choose the one you want to use.
...
Orka provides many integrations and plugins to set up a CI/CD pipeline with your preferred service provider. You can also build an in-house CI/CD integration with the [Orka3 CLI](https://support.macstadium.com/hc/en-us/articles/28347375974555) or the [Orka3 API](https://support.macstadium.com/hc/en-us/articles/28349313921563). This page focuses on the ready CI/CD solutions for Orka.
...
## 1\. Before you begin
  ...
  3. Connect to your Orka cluster via VPN. Make sure that your CI/CD integration can reach the cluster via VPN.
     1. [Download and install a VPN client](https://support.macstadium.com/hc/en-us/articles/28329406438683). Note that if you're using a custom Orka domain, you might need to make some additional configuration changes.
...
## 2\. Some Orka CI/CD basics
  ...
  * CI/CD integrations must target your Orka API URL. If you are using an [Orka domain](https://support.macstadium.com/hc/en-us/articles/28329724250011) or an [external custom domain](https://support.macstadium.com/hc/en-us/articles/28330039248923), you must ensure that the CI/CD integration can resolve the domain.
...
You can get your Orka API URL from your [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883):
  ...
  * You can also use `https://<orka-domain>` and `https://<custom-domain>`(if configured). To get the [Orka domain](https://orkadocs.macstadium.com/docs/custom-domains) for your Orka cluster, contact MacStadium. To use an external custom domain, see [here](https://orkadocs.macstadium.com/docs/custom-tls-certificate).
...
Go to [Orka Tools & Integrations](https://support.macstadium.com/hc/en-us/articles/28347376278299) and review the latest list of available integrations. Pick the one you want to use and navigate to its detailed setup instructions (usually available in the respective repo or official integration page).
