...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28347375974555-Orka3-CLI-Quick-Start"
...
## 2\. Download and configure the Orka3 CLI
  ...
  1. Download and install the latest [Orka3 CLI](https://support.macstadium.com/hc/en-us/articles/28347376278299) that matches your environment version.
...
```
This action ensures that your VM is running the latest version of the [Orka VM Tools](https://orkadocs.macstadium.com/docs/vm-tools). This collection of services lets Orka manage the guest operating system on Apple silicon-based VMs more efficiently and enables key features, such as [shared VM storage](https://support.macstadium.com/hc/en-us/articles/28340384486683).

If your cluster and CLI are not running the latest Orka version, download and install an [Orka VM Tools](https://support.macstadium.com/hc/en-us/articles/28340435787163) that matches the versions of your cluster and Orka3 CLI.
