...
If you want to skip the detailed explanations, just run through these steps on your own:
  ...
  9. Run Apple Screen Sharing to connect to the VM instance. Use `vnc://<VM-IP>:<Screenshare-port>` with the IP and port from Step 6. Use the `admin/admin` credentials.
