...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28393197020059-Web-UI-Quick-Start"
section: "Quick Start Guides"
category: "Orka"
created_at: "2024-08-19T13:07:20Z"
updated_at: "2025-07-23T13:15:17Z"
promoted: false
labels: ["orka", "api", "web", "ui"]
suggested_new_path: "/orka/quick-start-guides/web-ui-quick-start"
---
...
## 1\. Before you begin
  ...
  1. Ensure you can access your cluster account in the MacStadium Customer Portal. See [Cluster Access Management: Overview](https://support.macstadium.com/hc/en-us/articles/28328584628379).
  2. Get your VPN connection information from your IP Plan. You can [download](https://support.macstadium.com/hc/en-us/articles/28230867289883) it from the [MacStadium portal](https://portal.macstadium.com/).
  3. Connect to your Orka cluster via VPN.
     1. [Download and install a VPN client](https://support.macstadium.com/hc/en-us/articles/28329406438683). Note that you might need to make additional configuration changes if you're using a custom Orka domain.
...
> 
> You can get your Orka API URL from your [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883):
> 
...
![634a6b0-Screenshot_2023-10-10_at_23.42.27.png](https://support.macstadium.com/hc/article_attachments/28393197002523)
...
![0b2dd08-Screenshot_2023-10-10_at_23.55.17.png](https://support.macstadium.com/hc/article_attachments/28393224435355)
...
![310d27c-Screenshot_2023-10-10_at_23_59_26.jpg](https://support.macstadium.com/hc/article_attachments/28393197006875)
...
![ef0c92e-Screenshot_2023-10-11_at_0_02_21.jpg](https://support.macstadium.com/hc/article_attachments/28393224438683)
...
> 
> If you're using another image as your starting point or if you are installing your OS from ISO (Intel Only), you will likely not have SSH or Screen Sharing enabled by default (even though the respective ports will be mapped by default). In this case, you need to [connect to the VM via VNC](https://orkadocs.macstadium.com/docs/vnc-to-a-vm). You can then [enable SSH and Screen Sharing](https://orkadocs.macstadium.com/docs/orka-vms-ssh-vnc-screen-sharing#managing-ssh-or-screen-sharing) connectivity in the OS.
...
```
This action ensures that your VM (Virtual Machine) is running the latest version of the [Orka VM Tools](https://orkadocs.macstadium.com/docs/vm-tools). This collection of services lets Orka manage the guest operating system on Apple silicon-based VMs (Virtual Machines) more efficiently and enables vital features, such as [shared VM storage](https://orkadocs.macstadium.com/docs/shared-vm-storage).

If your cluster is not running the latest Orka version, download and install an [Orka VM Tools](https://orkadocs.macstadium.com/docs/downloads#orka-vm-tools-for-arm-vms) that matches the version of your cluster.
...
![2919446-save-2.jpg](https://support.macstadium.com/hc/article_attachments/28393197010843)

  2. Provide a name for the new image and click **Save**.



![028e8d7-save-dialog.png](https://support.macstadium.com/hc/article_attachments/28393197013787)
...
![af25e3d-delete.jpg](https://support.macstadium.com/hc/article_attachments/28393197015195)
