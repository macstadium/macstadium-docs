...
description: "If you want to automate your Orka cluster or build on top of it using REST,  this is your starting point. Authenticate via CLI token, then use REST calls to deploy VMs, manage images, and build custom integrations."
...
Note that you can use `http://<orka-IP>`, `https://<orka-domain>`, and `https://<custom-domain>` interchangeably in your workflows.
  ...
  * The complete API reference is available [here](https://macstadium.github.io/orka-api-docs/).
