...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28349313921563-Orka3-API-Quick-Start"
section: "Quick Start Guides"
category: "Orka"
created_at: "2024-08-16T21:04:39Z"
updated_at: "2025-07-22T22:42:29Z"
promoted: false
labels: ["orka", "api"]
suggested_new_path: "/orka/quick-start-guides/orka3-api-quick-start"
---
...
If you want to skip the detailed explanations, just run through these steps on your own:
  ...
  2. [List your nodes](https://orkadocs.macstadium.com/reference/listnodes) and check their state in the response.
  3. List the available [VMs](https://orkadocs.macstadium.com/reference/listvms) with the API.
  4. [Deploy your first VM instance](https://orkadocs.macstadium.com/reference/vmdeploy).
  ...
  7. [Commit](https://orkadocs.macstadium.com/reference/imagecommit) or [save the changes](https://orkadocs.macstadium.com/reference/imagesave) to a new base image (use the VM name from Step 4).
  8. [Deploy another VM instance](https://orkadocs.macstadium.com/reference/vmdeploy).
  9. Run Apple Screen Sharing and connect to the newly deployed VM. Use the connection information returned in Step 8.
  10. [Delete](https://orkadocs.macstadium.com/reference/deletevm) your VM instances.
  11. [List](https://orkadocs.macstadium.com/reference/listvms) your VMs.
...
## Before you begin
  ...
  1. Make sure you can access the account for your cluster in the MacStadium Customer Portal. See [Cluster Access Management: Overview](https://support.macstadium.com/hc/en-us/articles/28328584628379).
  ...
  3. Connect to your Orka cluster via VPN. 
     * [Download and install a VPN client](https://support.macstadium.com/hc/en-us/articles/28329406438683). Note that if you're using a custom Orka domain, you might need to make some additional configuration changes.
...
You can get your Orka API URL from your [IP Plan](https://support.macstadium.com/hc/en-us/articles/28230867289883):
  ...
  * You can also use `https://<orka-domain>` and `https://<custom-domain>`(if configured). To get the [Orka domain](https://support.macstadium.com/hc/en-us/articles/28329724250011) for your Orka cluster, contact MacStadium. To use an external custom domain, see [here](https://orkadocs.macstadium.com/docs/custom-tls-certificate).
...
Note that you can use `http://<orka-IP>`, `https://<orka-domain>`, and `https://<custom-domain>` interchangeably in your workflows.
  ...
  * The complete API reference is available [here](https://orkadocs.macstadium.com/reference).
...
```
This action ensures that your VM is running the latest version of the [Orka VM Tools](https://support.macstadium.com/hc/en-us/articles/28340435787163). This collection of services lets Orka manage the guest operating system on Apple silicon-based VMs more efficiently and enables vital features, such as [shared VM storage](https://support.macstadium.com/hc/en-us/articles/28340384486683).

If your cluster is not running the latest Orka version, download and install an [Orka VM Tools](https://support.macstadium.com/hc/en-us/articles/28340435787163) that matches the version of your cluster.
