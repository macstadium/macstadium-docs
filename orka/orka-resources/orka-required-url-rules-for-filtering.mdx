...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/39459868610203-Orka-Required-URL-Rules-for-Filtering"
section: "Orka Resources"
category: "Orka"
created_at: "2025-07-29T17:45:24Z"
updated_at: "2025-08-06T20:36:10Z"
promoted: false
labels: []
suggested_new_path: "/orka/orka-resources/orka-required-url-rules-for-filtering"
---

## About[](https://orkadocs.macstadium.com/docs/orka-32-release-notes#about)
...
## Overview[](https://orkadocs.macstadium.com/docs/orka-32-release-notes#overview)
...
## Rulesets[](https://orkadocs.macstadium.com/docs/orka-32-release-notes#rulesets)
...
sso.macstadium.com | Single sign-on requirement  
Permit Client | API Controllers  
10.221.188.19  
10.221.188.20 | HTTP  
TCP 6443 |  |  | .19 requires TCP/6443 - Ku. LB  
.20 requires HTTP - ORKA API  
Permit Client | 10.221.188.22 |  | HTTPS |  | Traefik - a reverse proxy  
Use case: if customer is using HTTPS to access ORKA  
Permit Client | 10.221.188.31 through 10.221.189.254 | TCP 5900-5912  
TCP 5999-6011  
TCP 8822-8834 |  |  | Reserved ports for interacting with created VMs  
Permit Client | 10.221.188.0/23 |  | ICMP  
SSH |  | Ask/Requirement for ORKA Support during troubleshooting sessions  
