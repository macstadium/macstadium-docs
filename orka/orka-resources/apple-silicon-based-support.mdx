...
Below is a list of the ones that are not applicable to Apple silicon-based VMs:
  ...
  * Bring your own macOS serial number feature
  ...
  5. Shared VM storage is not supported for Apple silicon-based VMs running macOS Monterey. To use shared VM storage, upgrade your Apple Silicon-based Monterey VMs to macOS Ventura or later, or switch to Intel-based Monterey VMs.
