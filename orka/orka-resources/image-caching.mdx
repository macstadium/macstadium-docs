...
After the cluster nodes are upgraded to version 3.2, users can access the new Image Caching feature and support for Sequoia guest OS VMs. To gain familiarity with Scheduled Caching via the Orka3 CLI, take the following steps:
