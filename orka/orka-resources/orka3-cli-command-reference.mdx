...
Remote and local images are accessible from all namespaces. To target a specific namespace, use `--namespace` or set the `ORKA_DEFAULT_NAMESPACE` environment variable.
