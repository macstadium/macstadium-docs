...
zendesk_url: "/orka/orka-resources/shared-vm-storage"
section: "Orka Resources"
category: "Orka"
created_at: "2024-08-16T17:46:17Z"
updated_at: "2025-08-01T14:02:57Z"
promoted: false
labels: ["orka", "api", "storage", "shared"]
suggested_new_path: "/orka/orka-resources/shared-vm-storage"
---

#### **Apple Silicon-based Monterey VMs**

Starting with [Orka 2.4.0](https://orkadocs.macstadium.com/docs/orka-v240), shared VM storage is deprecated for Apple Silicon-based VMs running macOS Monterey. Intel-based Monterey VMs are not affected.

In [Orka 3.0](https://orkadocs.macstadium.com/docs/orka-v300), shared VM storage is enabled for Applie Silicon macOS Ventura and newer.
...
[Learn more about pulling an image](https://orkadocs.macstadium.com/docs/image#pull-an-image-from-the-remote-repo)
...
![fe2b601-Screen_Shot_2021-07-23_at_5.07.33_PM.png](https://support.macstadium.com/hc/article_attachments/28340384462491)

Click the OK button to allow access. You will then be able to access files on the volume:

![e84d4f8-Screen_Shot_2021-07-23_at_6.11.28_PM.png](https://support.macstadium.com/hc/article_attachments/28340339123227)
...
![1f2144e-Screen_Shot_2021-07-26_at_11.24.03_AM.png](https://support.macstadium.com/hc/article_attachments/28340339125531)
...
![520ff79-Screen_Shot_2021-07-26_at_11.29.14_AM.png](https://support.macstadium.com/hc/article_attachments/28340384468251)

You will then be prompted to enter your password. Next, click the checkbox next to sshd-keygen-wrapper:

![2199d4a-Screen_Shot_2021-07-26_at_11.32.14_AM.png](https://support.macstadium.com/hc/article_attachments/28340339129371)
