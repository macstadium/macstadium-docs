...
description: "Mount a shared storage volume across Orka VMs for CI artifact caching. Available for Apple silicon and Intel VMs running macOS Ventura or later."
...
| Intel, macOS Ventura (13) and Sonoma (14) | Supported |  |
...
To fix this issue, connect to the VM via VNC and navigate to **System Settings → Privacy & Security → Full Disk Access**. Click the padlock to make changes:
