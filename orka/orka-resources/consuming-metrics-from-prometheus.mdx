...
The [Orka GitHub Actions integration](https://github.com/macstadium/orka-github-actions-integration) can optionally expose Prometheus metrics for runner scale set statistics. This is opt-in and disabled by default.
