...
description: "Scrape Prometheus metrics from your Orka cluster: server, operator, and node exporter endpoints. Covers Prometheus config, the web console, and Grafana."
zendesk_id: 28336861751963
zendesk_url: "/orka/orka-resources/consuming-metrics-from-prometheus"
