...
- **Pinned build environments.** Bazel pins toolchain state into the action hash. If your worker's Xcode version or SDK drifts, cache hits collapse. Orka 3.5's Harbor OCI registry lets you version, sign, and pin your build images the same way you'd pin a container image. Bare metal has no equivalent primitive.
