...
<Tip>
Looking for a working starting point? The [packer-plugin-macstadium-orka](https://github.com/macstadium/packer-plugin-macstadium-orka) repository includes ready-to-use Packer templates you can copy and adapt for your own image builds.
</Tip>
