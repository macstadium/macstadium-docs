...
<Tip>
Looking for a working starting point? The [packer-plugin-orka](https://github.com/macstadium/packer-plugin-orka) repository on OrkaHub includes ready-to-use Packer templates you can copy and adapt for your own image builds.
</Tip>
