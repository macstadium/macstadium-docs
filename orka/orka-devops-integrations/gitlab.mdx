---
title: "GitLab CI/CD integration for Orka"
description: "Connect Orka to GitLab CI/CD with the MacStadium integration. Set up Shell and custom executors with configuration scripts and template files for macOS builds."
