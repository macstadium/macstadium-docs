...
MacStadium provides a TeamCity plugin that you need to install and configure. Install it directly from the [JetBrains Marketplace](https://plugins.jetbrains.com/plugin/13662-orka-by-macstadium).
