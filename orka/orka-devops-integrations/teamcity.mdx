...
> **IMPORTANT**
> 
> Make sure that your TeamCity server is connected to your Orka environment through VPN. You can use a [VPN client](https://orkadocs.macstadium.com/docs/vpn-connect) to establish temporary connectivity, or you can create a [site-to-site VPN tunnel](/orka/networking-with-orka-at-macstadium/aws-orka-connections) to keep the connection alive at all times.
