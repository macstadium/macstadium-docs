---
title: "Orka Desktop 3.0 local macOS virtualization tool"
...
**Orka Desktop** has a clear and intuitive GUI, which makes it easy to transition to using Orka in the cloud. It provides information about your system, available images, and VMs.
...
_Download Latest (to get the latest files from Apple)_
...
![New VM dialog with Pull from an Image option selected](/images/attachments/28396594783131.png)

_Pull from an Image_
