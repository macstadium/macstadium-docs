...
For more information on using Harbor with the Orka3 CLI, review our existing documentation at: [Using Harbor OCI storage with the Orka CLI](/orka/oci-images/using-harbor-oci-storage-with-the-orka-cli)