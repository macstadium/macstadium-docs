...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28328612687899-Customer-Portal-Manage-Account-Users"
section: "Orka Cluster Access"
category: "Orka"
created_at: "2024-08-16T12:56:08Z"
updated_at: "2024-09-18T21:47:47Z"
promoted: false
labels: ["access", "orka", "api", "cluster"]
suggested_new_path: "/orka/orka-cluster-access/customer-portal-manage-account-users"
---
...
![36c44fa-account-menu.jpg](https://support.macstadium.com/hc/article_attachments/28328612678939)
  3. Click + Add, fill in the New User form, and click Create. 
     ...
     * When choosing a role for the user, keep in mind the [role-based access matrix](https://support.macstadium.com/hc/en-us/articles/28328584628379).
...
![36c44fa-account-menu.jpg](https://support.macstadium.com/hc/article_attachments/28328612678939)
  ...
  4. Update the user details or role. Note that а role change will not affect the respective cluster user directly, if they are currently logged in the Orka cluster. For the change to take effect, the user must obtain a new authentication token by logging out and logging back in. 
     * When choosing a role for the user, keep in mind the [role-based access matrix](https://support.macstadium.com/hc/en-us/articles/28328584628379).
