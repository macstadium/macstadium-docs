...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/28346085154971-2-4-x-to-3-0-0-API-Mapping"
...
---|---  
`{GET|POST|DELETE|PUT} /users` | Removed. See [Cluster Access Management: Overview](https://support.macstadium.com/hc/en-us/articles/28328584628379).  
`POST /users/password` | Removed. See [Cluster Access Management: Overview](https://support.macstadium.com/hc/en-us/articles/28328584628379).  
`POST /users/groups/myUserGroup` | Removed. Grouping is now handled via namespaces and role bindings. See [Orka Cluster: Manage Access to Resources](https://support.macstadium.com/hc/en-us/articles/28333357279387).  
`POST /users/groups/$ungrouped` | Removed. Grouping is now handled via namespaces and role bindings. See [Orka Cluster: Manage Access to Resources](https://support.macstadium.com/hc/en-us/articles/28333357279387).  
...
`POST /resources/node/groups/myUserGroup` | Removed. Grouping is now handled via namespaces and role bindings. See [Orka Cluster: Manage Access to Resources](https://orkadocs.macstadium.com/docs/orka-cluster-resource-access).  
`POST /resources/node/groups/$ungrouped` | Removed. Grouping is now handled via namespaces and role bindings. See [Orka Cluster: Manage Access to Resources](https://orkadocs.macstadium.com/docs/orka-cluster-resource-access).  
