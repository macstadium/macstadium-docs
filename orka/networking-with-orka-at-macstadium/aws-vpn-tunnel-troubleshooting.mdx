...
**Workaround:** Sometimes, the command line interface is case-sensitive and you need to preserve the capitalization of the network configuration as provided in the [IP Plan](/macstadium/macstadium-overview/ip-plan).  
