...
<Note>
**Before you begin:** You need an active VPN connection to your Orka cluster, your Cisco ASAv connection information from the [IP Plan](/macstadium/macstadium-overview/ip-plan), and the downloaded and prepared [VPN configuration file](/orka/networking-with-orka-at-macstadium/2-aws-vpn-tunnel-configuration-file).
</Note>
