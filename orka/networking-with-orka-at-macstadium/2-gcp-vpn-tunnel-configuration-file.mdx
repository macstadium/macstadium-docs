...
description: "Complete the Cisco ASA/ASAv config template for your GCP-to-Orka VPN tunnel. Fill in GCP network, VPN IP, Orka Private-1 network, and IKEv2 pre-shared key."
zendesk_id: 28400048105243
zendesk_url: "/orka/networking-with-orka-at-macstadium/2-gcp-vpn-tunnel-configuration-file"
