...
<Note>
**Before you begin:** You need the IP address for `FW1-Outside` and the CIDR range for `Private-1` (most likely `10.221.188.0/24` or `10.10.10.0/24`) from your [IP Plan](/macstadium/macstadium-overview/ip-plan).
</Note>
