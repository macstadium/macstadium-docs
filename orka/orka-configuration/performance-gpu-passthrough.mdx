...
- For Orka clusters with 2013 Mac Pro nodes, GPU passthrough on those nodes requires dual AMD FirePro D500 cards. Both cards will be passed to the VM at once.
