...
zendesk_url: "/orka/orka-upgrades-and-release-notes/orka-32-release-notes"
...
To set up an Apple ID compatible VM environment with Orka:
  ...
  1. Download [Orka Desktop](/orka/orka-desktop/welcome-to-orka-desktop-30) to begin the VM creation process. Makes sure your Host OS is Sequoia or later.
