...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/39572301543323-Orka-3-2-Release-Notes"
section: "Orka Upgrades and Release Notes"
category: "Orka"
created_at: "2025-08-01T14:27:41Z"
updated_at: "2025-09-03T19:07:19Z"
promoted: false
labels: []
suggested_new_path: "/orka/orka-upgrades-and-release-notes/orka-32-release-notes"
---
...
## Improvements and fixes[](https://orkadocs.macstadium.com/docs/orka-322-release-notes#improvements-and-fixes)

### Fix: incomplete VM deletion[](https://orkadocs.macstadium.com/docs/orka-322-release-notes#fix-incomplete-vm-deletion)
...
### Fix: Custom users created during authentication[](https://orkadocs.macstadium.com/docs/orka-322-release-notes#fix-custom-users-created-during-authentication)
...
To set up an Apple ID compatible VM environment with Orka:
  ...
  1. Download [Orka Desktop](https://support.macstadium.com/hc/en-us/articles/28396626048667-Welcome-to-Orka-Desktop-3-0) to begin the VM creation process. Makes sure your Host OS is Sequoia or later.
  ...
  4. If you want to deploy the image to your Orka cluster, use Orka Desktop to push your image to an OCI repository, and then use the [Orka CLI](https://support.macstadium.com/hc/en-us/articles/28347376278299-Tools-Integrations) to deploy to your Orka cluster.
...
## Improvements and fixes[](https://orkadocs.macstadium.com/docs/orka-321-release-notes#improvements-and-fixes)

### Image caching deletion fix[](https://orkadocs.macstadium.com/docs/orka-321-release-notes#image-caching-deletion-fix)
...
### Fix: Issue where image import directory was removed by the cache clearing processs[](https://orkadocs.macstadium.com/docs/orka-321-release-notes#fix-issue-where-image-import-directory-was-removed-by-the-cache-clearing-processs)
...
### Orka node status logic update[](https://orkadocs.macstadium.com/docs/orka-321-release-notes#orka-node-status-logic-update)
...
### Improved Orka node architecture detection[](https://orkadocs.macstadium.com/docs/orka-321-release-notes#improved-orka-node-architecture-detection)
...
### GitHub Actions Plugin null VM name issue[](https://orkadocs.macstadium.com/docs/orka-321-release-notes#github-actions-plugin-null-vm-name-issue)
...
# Orka 3.2.0 What’s New in the Release[](https://orkadocs.macstadium.com/docs/orka-32-release-notes-1#whats-new-in-the-release)
...
## Scheduled Caching[](https://orkadocs.macstadium.com/docs/orka-32-release-notes-1#scheduled-caching)
...
## Sequoia Support[](https://orkadocs.macstadium.com/docs/orka-32-release-notes-1#sequoia-support)
...
## Kubernetes update[](https://orkadocs.macstadium.com/docs/orka-32-release-notes-1#kubernetes-update)
...
## Upgrading[](https://orkadocs.macstadium.com/docs/orka-32-release-notes-1#upgrading)
...
> **🗒️NOTES**
> 
>   * Orka 3.2.0 is a new Orka release upgrade. For more information, see [Orka Upgrades](https://orkadocs.macstadium.com/docs/orka-upgrades#virtualization-and-orchestration-layer-upgrades-kubernetes-docker-or-linux).
>   * For customers who have not yet upgraded to Orka Cluster 3.0.0 please read the [migration guide](https://dash.readme.com/project/orka/v3.2.0/docs/post-300-migration-actions) before submitting a ticket.
> 
