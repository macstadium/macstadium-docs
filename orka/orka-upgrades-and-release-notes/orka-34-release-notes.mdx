...
zendesk_url: "https://support.macstadium.com/hc/en-us/articles/39593054198427-Orka-3-4-Release-Notes"
section: "Orka Upgrades and Release Notes"
category: "Orka"
created_at: "2025-08-01T21:06:20Z"
updated_at: "2025-09-12T12:36:37Z"
promoted: false
labels: []
suggested_new_path: "/orka/orka-upgrades-and-release-notes/orka-34-release-notes"
---
...
Summary:[](https://orkadocs.macstadium.com/docs/orka-342-release-notes#summary)
...
### Who is affected:[](https://orkadocs.macstadium.com/docs/orka-342-release-notes#who-is-affected)
...
### Impact:[](https://orkadocs.macstadium.com/docs/orka-342-release-notes#impact)
...
### Customer downtime:[](https://orkadocs.macstadium.com/docs/orka-342-release-notes#customer-downtime)

This is a zero-downtime operation and has no effect on already running VMs.

### Next steps:[](https://orkadocs.macstadium.com/docs/orka-342-release-notes#next-steps)
...
If you have any questions or require assistance, please [contact our support team](https://support.macstadium.com/hc/en-us/articles/28260744525723-Support).  
...
### Who is affected:[](https://orkadocs.macstadium.com/docs/orka-341-release-notes#who-is-affected)
...
### Impact:[](https://orkadocs.macstadium.com/docs/orka-341-release-notes#impact)
...
### Customer downtime:[](https://orkadocs.macstadium.com/docs/orka-341-release-notes#customer-downtime)

This is a zero-downtime operation and has no effect on already running VMs.

### Next steps:[](https://orkadocs.macstadium.com/docs/orka-341-release-notes#next-steps)
...
## New Features[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#new-features)
...
### Set display settings at VM deployment:[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#set-display-settings-at-vm-deployment)
...
### Examples:[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#examples)
...
### Set display settings for VM configurations:[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#set-display-settings-for-vm-configurations)
...
### Set display settings via Orka API at VM deployment[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#set-display-settings-via-orka-api-at-vm-deployment)
...
### Set display settings via Orka API at VM configuration[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#set-display-settings-via-orka-api-at-vm-configuration)
...
### Improvements to existing features[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#improvements-to-existing-features)
...
### Bug fixes[](https://orkadocs.macstadium.com/docs/orka-34-release-notes#bug-fixes)
