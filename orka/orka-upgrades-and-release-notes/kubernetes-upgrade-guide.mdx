...
description: "How Orka API server, operator, and webhook services behave during a Kubernetes cluster upgrade, and best practices to minimize disruption to running VMs."
---
