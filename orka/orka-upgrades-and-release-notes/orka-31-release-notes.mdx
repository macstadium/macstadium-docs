...
**Workaround:** MacStadium has published a new base Sonoma image with System Integrity Protection (SIP) disabled [SIP-disabled images on GitHub](https://github.com/macstadium/orka-images/tree/main?tab=readme-ov-file#sip-disabled).
