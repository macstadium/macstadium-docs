...
zendesk_url: "/orka/orka-upgrades-and-release-notes/orka-31-release-notes"
section: "Orka Upgrades and Release Notes"
category: "Orka"
created_at: "2025-08-01T14:24:36Z"
updated_at: "2025-08-06T20:30:49Z"
promoted: false
labels: []
suggested_new_path: "/orka/orka-upgrades-and-release-notes/orka-31-release-notes"
---

New features, improved functionality, and bug fixes in Orka v3.1.x  
Released: May 9, 2024

[__](https://orkadocs.macstadium.com/edit/orka-v310)____
...
# Orka v3.1.0[](https://orkadocs.macstadium.com/docs/orka-v310#orka-v310)
...
## New features[](https://orkadocs.macstadium.com/docs/orka-v310#new-features)

### Orka 3.1.0 now provides support for public IPs in the CLI and integrations[](https://orkadocs.macstadium.com/docs/orka-v310#orka-310-now-provides-support-for-public-ips-in-the-cli-and-integrations)
...
```
### (Intel-only) Support for old OS versions[](https://orkadocs.macstadium.com/docs/orka-v310#intel-only-support-for-old-os-versions)
...
```
### Image size details[](https://orkadocs.macstadium.com/docs/orka-v310#image-size-details)
...
## Removed and deprecated features[](https://orkadocs.macstadium.com/docs/orka-v310#removed-and-deprecated-features)

### Orka 2.x API[](https://orkadocs.macstadium.com/docs/orka-v310#orka-2x-api)
...
### Orka 2.x CLI[](https://orkadocs.macstadium.com/docs/orka-v310#orka-2x-cli)

Orka 2.x CLI and earlier versions are now **removed**. You must migrate your custom Orka functionality to use the new Orka3 API or the new Orka3 CLI instead. See [2.4.x to 3.0.0: API Mapping](https://orkadocs.macstadium.com/docs/24-to-30-cli-mapping-copy) , [2.4.x to 3.0.0: CLI Mapping](https://orkadocs.macstadium.com/docs/240-to-300-cli-mapping) and [2.4.x and 3.0.x to 3.1.x and above: Backward Compatibility](https://orkadocs.macstadium.com/docs/24x-to-300-backward-compatibility-copy).
...
## Improvements[](https://orkadocs.macstadium.com/docs/orka-v310#improvements)
...
## Known issues[](https://orkadocs.macstadium.com/docs/orka-v310#known-issues)
...
```
## How to upgrade[](https://orkadocs.macstadium.com/docs/orka-v310#how-to-upgrade)

> **Scheduled maintenance window required**
> 
> Orka 3.1.0 is a new Orka release upgrade. For more information, see [Orka Upgrades](https://orkadocs.macstadium.com/docs/orka-upgrades#virtualization-and-orchestration-layer-upgrades-kubernetes-docker-or-linux).
> 
