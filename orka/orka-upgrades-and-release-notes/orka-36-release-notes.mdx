...
**Minimum host OS requirement change:** Orka 3.7 will require macOS 15.0 (Sequoia) or later on the host. Customers running macOS 14 (Sonoma) or earlier should plan to upgrade their hosts to Sequoia ahead of the 3.7 release.
