...
description: "Use Kubernetes persistent volumes in Orka custom pod namespaces. Request a PV from MacStadium, set up kubectl access, create PVCs, and deploy pods."
zendesk_id: 28335731320603
zendesk_url: "/orka/kubernetes-native/k8s-native-persistent-volumes"
