...
To install Orka Engine on an Apple silicon host (M1 or later) running macOS 15 (Sequoia) and above, it is necessary to acquire and run the installer package.
