...
This guide introduces IT administrators to managing a deployed MacStadium VDI environment. Once you've completed the initial deployment following the [MacStadium VDI deployment guide](/remote-desktop-vdi/macstadium-vdi-deployment/deployment-guide) this document covers ongoing operations, user management, and system maintenance.
