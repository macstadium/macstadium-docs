...
> **Note**
> 
> The token is valid for 12 hours and will need to be refreshed regularly. See: [AWS ECR registry auth documentation](https://docs.aws.amazon.com/AmazonECR/latest/userguide/registry_auth.html#registry-auth-token)
> 
