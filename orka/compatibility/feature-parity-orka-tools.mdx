...
zendesk_url: "/orka/compatibility/feature-parity-orka-tools"
section: "Compatibility"
category: "Orka"
created_at: "2024-08-16T16:09:42Z"
updated_at: "2024-09-18T21:47:43Z"
promoted: false
labels: ["orka", "api", "compatibility", "parity"]
suggested_new_path: "/orka/compatibility/feature-parity-orka-tools"
---
...
* Requires additional configuration. See [Built-In Orka Domains](https://orkadocs.macstadium.com/docs/custom-domains) and [External Custom Domains](https://orkadocs.macstadium.com/docs/custom-tls-certificate).
...
Orka3 API | Orka3 CLI | Orka3 API | Web UI  
---|---|---|---  
List namespaces | ✅ | ✅ | ❌  
Create namespace | ✅ | ✅ | ❌  
Delete namespace | ✅ | ✅ | ❌  
