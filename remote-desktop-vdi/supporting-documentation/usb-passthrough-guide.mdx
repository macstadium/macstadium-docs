...
Citrix Workspace App for macOS (CWA Mac)
  ...
  * Known issue under active investigation by Citrix (see Citrix Workspace App for Mac release notes: [](https://docs.citrix.com/en-us/citrix-workspace-app-for-mac/whats-new.html#known-issues-1)[About this release | Citrix Workspace™ app for Mac](https://docs.citrix.com/en-us/citrix-workspace-app-for-mac/whats-new.html#known-issues-1) ).
