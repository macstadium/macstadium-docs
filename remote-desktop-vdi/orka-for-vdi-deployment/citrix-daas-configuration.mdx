...
zendesk_url: "/remote-desktop-vdi/orka-for-vdi-deployment/citrix-daas-configuration"
section: "Orka for VDI Deployment"
category: "Remote Desktop (VDI)"
created_at: "2025-12-12T16:09:43Z"
updated_at: "2026-02-25T21:38:59Z"
promoted: false
labels: []
suggested_new_path: "/remote-desktop-vdi/orka-for-vdi-deployment/citrix-daas-configuration"
---
...
Machine Catalogs are logical groupings of virtual machines in Citrix. When using Orka for VDI, you'll create a catalog specifically for your macOS desktops. With Orka for VDI, you'll use the Remote PC Access catalog type since Citrix treats each Mac as a physical device due to Apple's licensing requirements.
 ...
 * Reference: [](https://learn.microsoft.com/en-us/dotnet/core/install/macos)[Install .NET on macOS - .NET](https://learn.microsoft.com/en-us/dotnet/core/install/macos)
