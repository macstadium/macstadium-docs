...
description: "Create and manage golden images for Orka for VDI: build images with Citrix VDA pre-installed, automate builds with Ansible, and distribute across hosts."
zendesk_id: 44332794850971
zendesk_url: "/remote-desktop-vdi/orka-for-vdi-deployment/image-management"
...
Image management is critical for maintaining a scalable Orka for VDI environment. This section covers creating a golden image with the Citrix VDA pre-installed, automating image builds, distributing images across hosts, and implementing version control practices for long-term maintenance.
