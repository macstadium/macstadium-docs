...
keywords: ["production VDI deployment", "rollout checklist", "VDI go-live", "launch checklist"]
---
...
Additionally, you can choose to ship your logs to a central logging system (for example, Splunk, CloudWatch) for further research and analysis if deemed appropriate by your organization’s existing data policies and procedures.
...
If users need higher-performance desktops, upgrade to higher-spec Macs:
