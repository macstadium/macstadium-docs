...
For host-side configuration, error code reference, and latency diagnostics, see [Cloud Access Troubleshooting](/remote-desktop-vdi/cloud-access-legacy/cloud-access-troubleshooting).