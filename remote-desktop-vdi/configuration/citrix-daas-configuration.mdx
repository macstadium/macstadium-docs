...
**Creating the Machine Catalog:**
  ...
  4. **Configure Machine Catalog settings:**
     ...
     - **Description:** Document the purpose, OS version, and hardware specs (for example, "macOS Sonoma on M2 Mac mini, 16GB RAM, for finance team")
...
**To generate an enrollment token:**
  ...
  4. **Configure token settings:**
     ...
     - **Token name:** Descriptive identifier (for example, "Orka-Finance-Q1-2026")
...
**Creating a Delivery Group:**
  ...
  5. **Delivery Group name and settings:**
     ...
     - Display name: What users see in Citrix Workspace (for example, "macOS Finance Desktop")
