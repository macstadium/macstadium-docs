...
description: "Connect Orka VMs or bare metal Macs to Citrix Cloud for MacStadium VDI: Machine Catalogs, enrollment tokens, VDA install, Delivery Groups, and Rendezvous."
