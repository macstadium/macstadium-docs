...
### Apple Firewall and HP Anyware PCoIP
...
| Session fallback | N/A | TCP 4172 |
| Broker / licensing | TCP 443 | TCP 443, 60443 |
| EDT (performance) | UDP 1494, 2598 | N/A |
...
|---|---|---|
| Transport tuning | EDT settings, H.264/H.265 codec selection, audio quality profiles (see [Citrix Workspace App for Mac docs](https://docs.citrix.com/en-us/citrix-workspace-app-for-mac)) | `pcoip.max_link_rate`, image quality, and frame rate. Configure via the plist entries below. |
