...
<Note>
  Start conservative. MacStadium hosted deployments can add nodes without
  re-architecting — it's easier to add hosts than to right-size VM RAM after
  users are in production.
</Note>
