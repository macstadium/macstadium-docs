...
<CardGroup cols={3}>
  ...
  <Card title="Apple Business Manager and MDM" icon="mobile" href="/remote-desktop-vdi/configuration/apple-business-manager-and-mobile-device-management-with-macstadium">
    How ABM and MDM tools like Jamf, Kandji, and Intune integrate with MacStadium for host-level enrollment.
  </Card>
</CardGroup>
