---
title: "Architecture"
description: "MacStadium VDI architecture explained: the four system layers, user session flow, control plane responsibilities, and the three deployment models."
