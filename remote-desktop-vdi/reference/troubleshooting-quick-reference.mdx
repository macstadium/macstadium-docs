...
If your issue isn't listed here, see [Incident Response](/remote-desktop-vdi/operational-guides/incident-response) for escalation procedures.
...
6. Monitor logs proactively rather than reactively. See [Monitoring & Observability](/remote-desktop-vdi/operational-guides/monitoring) for setup guidance.