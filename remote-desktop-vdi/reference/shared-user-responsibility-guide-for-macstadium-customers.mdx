...
description: "Who owns what in a MacStadium VDI deployment. Defines responsibilities for MacStadium, the customer, and (where applicable) a Citrix Service Provider, across all three deployment models."
zendesk_id: 41205907064603
keywords: ["shared responsibility", "MacStadium support boundary", "Citrix Service Provider", "customer responsibilities VDI"]
---
