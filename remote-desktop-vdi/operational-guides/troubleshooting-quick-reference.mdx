...
```
  4. Check the user's SSO/company omain login
...
4\. Check Citrix Cloud status: [https://status.cloud.com](https://status.cloud.com/ "https://status.cloud.com")
...
Citrix Cloud service outage | Status page shows service issues | Check [status.cloud.com](http://status.cloud.com/ "http://status.cloud.com"); wait for Citrix to resolve; monitor status updates  
Network blocking Citrix Cloud | Can't reach [cloud.com](http://cloud.com/ "http://cloud.com") domains | Check firewall/proxy; verify outbound HTTPS allowed; try different network  
