...
Citrix HDX optimization:
  ...
  1. Enable [framehawk](https://docs.citrix.com/en-us/citrix-virtual-apps-desktops/2402-ltsr/graphics/framehawk.html "https://docs.citrix.com/en-us/citrix-virtual-apps-desktops/2402-ltsr/graphics/framehawk.html") for high-latency connections
...
Download the [Citrix HDX Monitor tool](https://cis.citrix.com/hdx/download/ "https://cis.citrix.com/hdx/download/") from the Citrix website. Run tests between user endpoints and VMs to identify bottlenecks such as:
...
Image: [registry.example.com/citrix-vda/sonoma-finance:v2.2](http://registry.example.com/citrix-vda/sonoma-finance:v2.2 "http://registry.example.com/citrix-vda/sonoma-finance:v2.2")  
