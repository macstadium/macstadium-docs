...
keywords: ["incident response VDI", "VDI troubleshooting escalation", "change management", "MacStadium support"]
---
...
```
Subject: [URGENT] VDI Issue: <brief description>
...
6. **Performance test:** Measure login time (target: <30 seconds), check CPU/memory at idle, check responsiveness during typical tasks.
...
- Users impacted: <estimated number>
- IT team actively working on resolution

Workaround (if available): <any temporary workaround>
...
Summary:
- Issue duration: <start time> to <end time>
- Root cause: <brief, non-technical explanation>
- Resolution: <what was done>

If you continue to experience issues, contact <support email>.
...
| Login time | <30 seconds | Desktop launch to usable desktop |
| Session latency | <100ms round-trip | HDX session latency |
